...
| SA : 1 | SAC : 2, SAD : 3 | |
| SAC : 2 | SACF : 3 | |
| SACF : 3 (tie with SAD — labels: S-A-C before S-A-D) | SACFG : **4** ← goal queued | |
| SAD : 3 | SADF : $3+2$ = 5, SADG : $3+2$ = 5, SADB : $3+1$ = **4** | |
| SACFG : **4** — cheapest in OPEN (ties SADB/SB at 4 lose on labels) | a complete tour, everything left ≥ 4 → **optimal** | |
