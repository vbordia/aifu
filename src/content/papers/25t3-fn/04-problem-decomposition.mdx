  ...
  steps={[
    {
      ...
      elements: [
        ...
        { data: { id: "L", label: "L 2", type: "primitive" }, position: { x: 800, y: 240 } },
...
- **4.3** — **B (inadmissible)**: $h(A) = 30 > h^*(A) = 12$ ($A = $ AND(E,I) $= (4+2)+(4+2)$) — a massive overestimate.
...
4. Inadmissibility: h(A) = 30 vs true 12 — the giveaway.
</Accordion>
