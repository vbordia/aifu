...
| S : 0 | SF : 6, SD : 8, SE : 16 | |
| SF : 6 | SFB : 12, SFD : 16 | |
| SFB : 12 | SFBA : 16, SFBC : 20 | |
| SD : 8 | SDB : 16, SDF : 16, SDE : 18 | |
| SDB : 16 | SDBA : 20, SDBC : 24 | |
| SFD : 16 | SFDE : 26, SDFB : 24 | |
| SFBA : 16 | SFBAG : **20** ← goal on queue | |
| SDE : 18 | SDEC : 28 | |
| SFBC : 20, then SFBAG : **20** | all open ≥ 20 → **optimal** | |

Path: **S → F → B → A → G**, cost 20 ✓

## 1.4 — Shortest path → **C (both)**

Routes: S-F-B-A-G = **20** · S-D-B-A-G = 24 · S-F-D-B-A-G = 28 · S-E-C-G = 28. Both algorithms returned 20 → **C**.
