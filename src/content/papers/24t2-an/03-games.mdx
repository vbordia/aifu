...
A strategy must commit to ONE child at every MAX node; MIN nodes contribute all their children.

| Option | Check | Verdict |
|--------|-------|---------|
| **A: A,C** | Root→$M_1$ ✓; $M_1$ (MIN) keeps both children: A and $X_1$; $X_1$ (MAX) commits to C only ✓ | **Valid** |
| B: A,D,G | Root (MAX) would need $M_1$, $M_2$ **and** $M_3$ — split! | Invalid |
| **C: G,J,K** | Root→$M_3$ ✓; $M_3$ keeps G, $X_3$; $X_3$ commits to $Z_3$ (dropping $Y_3$: no H, I); $Z_3$ keeps J, K ✓ | **Valid** |
| D: D,E,F | Root→$M_2$ ✓; $M_2$ keeps D, $X_2$; but E and F are the two *children* of MAX node $X_2$ — it can't take both. Split! | Invalid |

Note the trap in option D: unlike the FN-24t1 tree, here E and F hang directly off a MAX node, so \{D,E,F\} is impossible while \{D,E\} would have been fine.
...
<PaperTrace
  ...
  nodes={[
    ...
    { id: "M3", label: "MIN", kind: "min", x: 730, y: 120 },
    ...
    { id: "G", label: "G: 20", x: 650, y: 230 },
    { id: "X3", label: "MAX", kind: "max", x: 812, y: 230 },
    { id: "Y3", label: "MIN", kind: "min", x: 680, y: 340 },
    { id: "Z3", label: "MIN", kind: "min", x: 945, y: 340 },
    { id: "H", label: "H: 42", x: 610, y: 450 },
    { id: "I", label: "I: 76", x: 750, y: 450 },
    { id: "J", label: "J: 88", x: 880, y: 450 },
    { id: "K", label: "K: 98", x: 1010, y: 450 }
  ]}
  edges={[
    { id: "x1", from: "R", to: "M1" },
    { id: "x2", from: "R", to: "M2" },
