...
| S : 0 | SA : 1, SB : 2 | |
| SA : 1 | SAE : 2, SAD : 4 | |
| SAE : 2 (tie with SB — S-A before S-B) | SAEF : 3 | |
| SB : 2 | SBD : 3, SBC : 4 | |
| SAEF : 3 (tie with SBD — S-A before S-B) | SAEFG : **4** ← goal queued | |
| SBD : 3 | SBDA : $3+3$ = **6**, SBDF : $3+1$ = **4**, SBDG : $3+2$ = 5, SBDC : $3+2$ = 5 | |
| SAD : 4 (first of the four-way tie at 4 — labels) | SADF : $4+1$ = 5, SADG : $4+2$ = 6 | |
| SAEFG : **4** — next at the tie, a complete tour | everything left ≥ 4 → **optimal** | |
