...
|------|----------------------------------|------|---------|
| 1 | S : 0, 120, **120** | **S** | B : 40, 90, 140 · A : 50, 120, 170 · D : 60, 80, 140 |
| 2 | B : **140**, D : 140, A : 170 | **B** | A via B: $g=70$ → 190 (worse than 170, keep 50/170) · E : 90, 40, **130** · D via B: $g=80$ → 160 (worse than 140, keep) |
...
<StepGraph
  ...
  steps={[
    ...
    {
      label: "Expand S",
      note: "Pick S (f=120).\nB: g=40, h=90 → f=140\nA: g=50, h=120 → f=170\nD: g=60, h=80 → f=140\nOPEN = { B(140), D(140), A(170) }",
      elements: [
        { data: { id: "S", label: "S", type: "explored" }, position: { x: 40, y: 220 } },
        { data: { id: "A", label: "A f=170", type: "frontier" }, position: { x: 260, y: 380 } },
        { data: { id: "B", label: "B f=140", type: "frontier" }, position: { x: 260, y: 220 } },
...
| 7 | SBD : 80, SBE : 90, SBAC : 90, SACG : 100, … | **SBD** | SDBA : 110, SDBE : 130 |
| 8 | SBE : 90, SBAC : 90, … | **SBE** | SBEG : 130, SBEC : 150 |
| 9 | SBAC : 90, SACG : 100, … | **SBAC** | SBACG : 120 |
...
<StepGraph
  ...
  steps={[
    ...
    {
      label: "Extend SBD",
      note: "Pop SBD(80).\nS,D,B,A:110   S,D,B,E:130\nOPEN = [ SBE:90, SBAC:90, SACG:100, SDB:100, SDF:120, SDBA:110, SDBE:130 ]",
      elements: [
        { data: { id: "S", label: "S", type: "explored" }, position: { x: 40, y: 220 } },
        { data: { id: "A", label: "A 110", type: "frontier" }, position: { x: 260, y: 380 } },
        { data: { id: "B", label: "B", type: "explored" }, position: { x: 260, y: 220 } },
        { data: { id: "D", label: "D", type: "explored" }, position: { x: 200, y: 60 } },
        { data: { id: "E", label: "E 90/130", type: "frontier" }, position: { x: 480, y: 80 } },
        { data: { id: "F", label: "F 120", type: "frontier" }, position: { x: 480, y: 220 } },
        { data: { id: "C", label: "C", type: "explored" }, position: { x: 700, y: 380 } },
        { data: { id: "G", label: "G 100", type: "frontier" }, position: { x: 900, y: 120 } },
        { data: { id: "e1", source: "S", target: "D", label: "60" } },
