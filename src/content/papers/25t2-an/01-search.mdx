...
| 3 | D : **16**, A : 17, C : 21 | **D** | E : 16, 7, 22 · F : 18, 4, 22 · C via D: 28 (keep 21) |
| 4 | A : **17**, C : 21, E : 22, F : 22 | **A** | E via A: 12, 7, **19** (improves 22!) |
...
| Pop | OPEN (path : $g$) | Extend with |
|-----|-------------------|-------------|
| S : 0 | SB : 4, SC : 16 | |
| SB : 4 | SBA : 8, SBD : 10, SBC : 16 | |
| SBA : 8 | SBAE : 12 | |
| SBAE : 12 | SBAEG : **20** ← goal on queue | |
| SBD : 10 | SBDA : 14, SBDE : 20, SBDC : 22, SBDF : 22 | |
| SBDA : 14 | SBDAE : 22 | |
| SBC : 16 | SBCF : 24 | |
| SBDE : 20 | SBDEG : 28 | |
| SBAEG : **20** | everything left ≥ 20 → **optimal, stop** | |
  ...
  steps={[
    ...
    },
    {
      ...
      elements: [
        ...
        { data: { id: "E", label: "E f=22", type: "frontier" }, position: { x: 480, y: 40 } },
    ...
    {
      label: "Expand A",
      note: "Pick A (f=17).\nE via A: g=12, h=7 → f=19 < 22 → UPDATE E!\nOPEN = { E(19), C(21), F(22) }",
      elements: [
        { data: { id: "S", label: "S", type: "explored" }, position: { x: 40, y: 200 } },
...
3. **A\* = sort by g+h; always test updates** — step 4 here (E improved 22 → 19) is where marks are lost.
